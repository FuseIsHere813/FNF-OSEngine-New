...
class FunkinLua {
	...
	public function new(script:String) {
		...
		Lua_helper.add_callback(lua, "addGlitchEffect", function(camera:String,waveSpeed:Float = 0.1,waveFrq:Float = 0.1,waveAmp:Float = 0.1) {	// os engine shit
			PlayState.instance.addShaderToCamera(camera, new GlitchEffectAlt(waveSpeed,waveFrq,waveAmp));
		});
		...
		Lua_helper.add_callback(lua, "addDistortionEffect", function(camera:String,waveSpeed:Float = 0.1,waveFrq:Float = 0.1,waveAmp:Float = 0.1) {
			luaTrace('addVCREffect is deprecated in favor of Runtime Shaders!', false, true);
			PlayState.instance.addShaderToCamera(camera, new DistortBGEffectAlt(waveSpeed,waveFrq,waveAmp));	
		});
		...
		Lua_helper.add_callback(lua, "addPulseEffect", function(camera:String,waveSpeed:Float = 0.1,waveFrq:Float = 0.1,waveAmp:Float = 0.1) {
			luaTrace('addVCREffect is deprecated in favor of Runtime Shaders!', false, true);
			PlayState.instance.addShaderToCamera(camera, new PulseEffectAlt(waveSpeed,waveFrq,waveAmp));
